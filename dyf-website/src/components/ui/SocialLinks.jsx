      ...
      {icons.map((item) => {
        ...
        return (
          <a
            ...
            className={`w-10 h-10 flex items-center justify-center rounded-md cursor-pointer text-white transition-all duration-300 ease-in-out hover:-translate-y-2 ${item.color}`}
          >
            <Icon size={20} />
          </a>
        );
