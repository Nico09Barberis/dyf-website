...
const HeroSection = () => {
  return (
    <section className="relative w-full min-h-[70vh] flex items-center justify-center bg-beige text-azulOscuro overflow-hidden">
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-6 text-center flex flex-col items-center gap-2">
        ...
        <p className="max-w-2xl text-gray-700 font-marcellus text-md md:text-lg">
          Vajilla elegante, higienizada y lista para acompañar tus celebraciones.
          Ideal para bodas, eventos corporativos y ocasiones especiales.
        </p>

        <div className="flex flex-col sm:flex-row gap-4 mt-4">
          <button className="px-8 py-3 bg-azulOscuro text-white font-semibold rounded-md hover:bg-opacity-90 transition">
