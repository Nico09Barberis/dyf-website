...
const sectionsData = [
  {
    ...
    images: [
      ...
      { src: "/images/bgPages/bgFullService.webp" },
  ...
  },
  {
    ...
    images: [
      ...
      { src: "/images/catFurniture/catBar.webp" },
      { src: "/images/galery/furniture/furniture-5.webp" },
      { src: "/images/galery/furniture/furniture-6.webp" },
      { src: "/images/galery/furniture/furniture-3.webp" },
      { src: "/images/galery/furniture/furniture-8.webp" },
      { src: "/images/catFurniture/catDecoracion.webp" },
      { src: "/images/galery/furniture/furniture-10.webp" },
    ],
  },
  {
    key: "vajilla",
    ...
    images: [
      ...
      { src: "/images/galery/tableware/tableware-7.webp" },
      { src: "/images/galery/tableware/tableware-4.webp" },
      { src: "/images/galery/tableware/tableware-5.webp" },
      { src: "/images/galery/tableware/tableware-6.webp" },
      { src: "/images/galery/tableware/tableware-2.webp" },
      { src: "/images/galery/tableware/tableware-8.webp" },
    ],
  },
];
  ...
  return (
    <div className="container mx-auto px-4 py-8 mt-12">
      <section className="mb-16 flex flex-col items-center text-center px-4 sm:px-6 lg:px-0">
        <h1 className="text-xl md:text-2xl lg:text-4xl font-marcellus font-semibold uppercase mb-2 text-azulOscuro">
          nuestra galeria
        </h1>
